    ...
    public boolean onCommand(CommandSender commandSender, Command command, String s, String[] strings) {
        ...
        switch (game) {
            case "spleef":
                ...
                if (!spleefQueue.addPlayer((Player) commandSender)) {
                    commandSender.sendMessage(Louise.PREFIX + "You can't join this game !");
                    return false;
                }
            ...
            case "ttn":
                ...
                if (!ttfQueue.addPlayer((Player) commandSender)) {
                    commandSender.sendMessage(Louise.PREFIX + "You can't join this game !");
                    return false;
                }
            ...
            case "anvil":
                    ...
                    if (!anvilQueue.addPlayer((Player) commandSender)) {
                        commandSender.sendMessage(Louise.PREFIX + "You can't join this game !");
                        return false;
                    }
